const displayChatSettings = () => {
  while (chatSettingsOverlay.firstChild)
    chatSettingsOverlay.removeChild(chatSettingsOverlay.firstChild);
  ...
  deleteBtn.append(
    bootStrapIcon("bi-trash-fill"),
    Object.assign(document.createElement("span"), { innerText: "Delete Chat" }),
  );
  ...
  settings.append(
    closeBtn,
    Object.assign(document.createElement("h2"), { innerText: "Chat settings" }),
    g1,
    g2,
    deleteBtn,
  );
...
document.addEventListener("keydown", function (event) {
  ...
  if (
    event.key === "Escape" &&
    chatSettingsOverlay.firstChild &&
